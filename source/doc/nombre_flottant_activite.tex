...
\begin{NSI}
{Activité}{Encoder les nombres à virgules}
\end{NSI}

Les nombres à virgule ont une représentation binaire. En informatique, ce sont des nombres \textbf{flottants}. Comment sont-ils encodés sur une machine ?

\section*{Représentation en virgule fixe}

On donne le nombre $1001,01$ écrit en binaire représentant un nombre à virgule.

\begin{enumerate}

\item Retrouver la valeur décimale de ce nombre.

\item On représente la partie avant la virgule et la partie après la virgule sur 1 octet chacune. 

\begin{enumerate}

\item Quelle est la valeur la plus grande que l'on peut représenter ?

\item Qu'en est-il si le nombre est signé ?

\end{enumerate}

\item Quel problème rencontre-t-on en codant la partie après la virgule sur 1 octet ?

\end{enumerate}

\section*{Représentation en virgule flottante}

La virgule flottante est une application en binaire de la notation scientifique utilisée en base 10. Cela revient donc à écrire un nombre en décalant la virgule jusqu'au premier chiffre non nul et à le multiplier par une puissance de la base pour garder sa valeur.

Par exemple : $123,45 = 1,2345 \times 10^{2}$
...
architecture & signe & exposant + décalage & mantisse - 1 \\\hline
32 bits & 1 bit & 8 bits & 23 bits\\\hline
64 bits & 1 bit & 11 bits & 52 bits\\\hline
\end{tabular}
\end{center}
